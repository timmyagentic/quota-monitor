...
struct SessionsViewWiringTests {
    ...
    func pagesUseRequestSnapshots() throws {
        ...
        #expect(source.contains("after: request.cursor"))
        #expect(source.contains("pageSize: request.pageSize"))
    ...
    func queryFacadeFetchesPages() throws {
        ...
        #expect(source.contains("after: cursor"))
        #expect(source.contains("pageSize: pageSize"))
        #expect(source.contains("\"has_cursor\": .bool(cursor != nil)"))
