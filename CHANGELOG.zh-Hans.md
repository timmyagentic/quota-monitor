...
- 现在可以自行选择是否分享匿名版本统计，在不发送账号或用量数据的前提下帮助了解仍在使用的应用版本。
...
- **可选的匿名版本统计。** 仅在明确同意后，Developer ID 版本才会发送 UTC 日期、应用版本、品牌、分发渠道、模式版本和每日轮换 token，帮助维护者查看匿名活跃安装的版本分布；可以随时在设置中关闭，中英双语隐私政策会说明保留期限和网络边界处理。
