...
- Codex 费用估算现在会区分明确记录的 Standard 与 Fast turn；Fast 开关只补齐旧版或未标记的历史。

### 变更

- **Codex Fast 按 turn 估算。** 近期 Codex turn 会按记录的服务档位偏好估算；现有开关只为旧版或未标记用量提供 Fast 回退，不会覆盖明确记录为 Standard 的 turn。
