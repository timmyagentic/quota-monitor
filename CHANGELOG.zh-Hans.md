...
- 更新提醒现在会跨重启保留、常驻显示在菜单栏，并在选择“稍后”后温和地再次提醒，不再悄悄消失。

### 新增

- **Quota Monitor 产品官网。** 新网站在电脑和手机上通过内容丰富的 30 天合成 Dashboard 与 Sessions 示例展示产品，点击下载按钮即可从官网直接获取最新的已公证 DMG，同时不会保留常规访客请求日志，也不会复用浏览器缓存中的旧安装包。

### 变更

- **温和的提醒节奏。** 选择“稍后”后，第一次提醒会准确安排在 24 小时后；在更新完成前，之后每 3 天再次提醒一次。
- **安静的菜单栏提醒。** 提醒到期时只会强调原生菜单栏状态项 8 秒，不会抢走焦点、打开窗口或请求通知权限。
- **清晰的更新选项。** 同一版本在推迟期间进行自动检查时会保持安静，但“立即检查”仍会展示更新；只有下载前可以选择“跳过”，准备安装后则提供“稍后”与“安装并重新启动”。

### 修复

- **待处理更新不再消失。** 待更新版本和菜单栏标记会跨重启保留，并在安装完成或确认当前版本、明确选择“跳过”，或者确定没有更新后清除。
