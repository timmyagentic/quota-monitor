/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 70456c32d09f6375e513ed27271ad782)
// Runtime types generated with workerd@1.20260710.1 2026-07-15 nodejs_compat
interface __BaseEnv_Env {
	PRIVATE_BETA_BUCKET: R2Bucket;
	VERSION_STATS_DB: D1Database;
	PRIVATE_BETA_DB: D1Database;
	DAILY_ACTIVE_RATE_LIMITER: RateLimit;
	DAILY_ACTIVE_COLO_RATE_LIMITER: RateLimit;
	ADMIN_VERSION_STATS_RATE_LIMITER: RateLimit;
	PRIVATE_BETA_ENROLL_RATE_LIMITER: RateLimit;
	PRIVATE_BETA_RESOURCE_RATE_LIMITER: RateLimit;
	PRIVATE_BETA_ADMIN_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	VERSION_STATS_ADMIN_TOKEN: string;
	PRIVATE_BETA_ADMIN_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VERSION_STATS_ADMIN_TOKEN" | "PRIVATE_BETA_ADMIN_TOKEN">> {}
}
