...
const english = Object.freeze({
  ...
  heroTitleFirstLine: "Quota at a glance,",
  heroTitleSecondLine: " right in your menu bar.",
  ...
  heroPrivacy: "Quota history stays on your Mac. Anonymous version statistics are documented in the privacy policy.",
  heroProductLabel: "Quota Monitor menu-bar popover and dashboard",
...
const simplifiedChinese = Object.freeze({
  ...
  chooseEnglish: "切换为英文",
  heroTitleFirstLine: "额度一目了然，",
  heroTitleSecondLine: "就在菜单栏。",
  heroDescription: "在菜单栏常驻查看 Codex 与 Claude Code 额度百分比，点击即可展开重置时间、Token 趋势、API 等价费用估算和会话明细。",
  heroPrivacy: "额度历史保留在 Mac 本地；匿名版本统计的范围与保留规则见隐私政策。",
  heroProductLabel: "Quota Monitor 菜单栏弹窗与仪表盘",
