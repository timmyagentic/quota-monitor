...
enum Migrations {
    ...
    static func register(in migrator: inout DatabaseMigrator) {
        ...
        // Codex parser starts wiring rollout JSONL fast_mode / quick_mode
        // markers. Force a Codex-only reimport so old Codex events can be
        // rebuilt with these fields; Claude import_state rows are
