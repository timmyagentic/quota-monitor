...
enum BundledPricingCatalog {
    ...
    private static let base: [PricingEntry] = [
        ...
        .init(modelId: "claude-fable-5-1", displayName: "Claude Fable 5.1",
              inputPricePerMillion: 10.00, cachedInputPricePerMillion: 0.25, outputPricePerMillion: 50.00,
              cacheCreationPricePerMillion: 12.50,
              effectiveModelId: "claude-fable-5-1", isOfficial: true,
              note: "Official price since 2026-09-01; cache reads use 0.025x base input.",
              sourceUrl: "https://platform.claude.com/docs/en/models/fable-5-1/whats-new-fable-5-1#pricing"),
